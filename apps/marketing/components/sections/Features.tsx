          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <span className="font-medium">Tailored Staffing Solutions</span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="font-medium">Experience Team</span>
              </div>
            </div>

            <div className="pt-4">
              <button className="px-8 py-4 rounded-lg bg-text-primary hover:bg-brand-orange text-white font-medium transition-colors inline-flex items-center gap-2">
                JOIN OUR NETWORK
